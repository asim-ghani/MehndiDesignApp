...
import com.ghani.mehndidesign.offline2023.simple.GlitterDetail;
import com.ghani.mehndidesign.offline2023.simple.R;

import java.util.ArrayList;

public class GlitterAdapter extends BaseAdapter {

    Context context;
    public static ArrayList<Bitmap> imgArray;

    public GlitterAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        GlitterAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, GlitterDetail.class);
