...
import com.ghani.mehndidesign.offline2023.simple.FhandDetail;
import com.ghani.mehndidesign.offline2023.simple.R;

import java.util.ArrayList;

public class FhandAdapter extends BaseAdapter {

    Context context;
    public static ArrayList<Bitmap> imgArray;

    public FhandAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        FhandAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    int pos = position;
                    Intent intent = new Intent(context, FhandDetail.class);
