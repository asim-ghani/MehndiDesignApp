...
import com.ghani.mehndidesign.offline2023.simple.ArabicDetail;
import com.ghani.mehndidesign.offline2023.simple.BridalDetail;
import com.ghani.mehndidesign.offline2023.simple.R;

import java.util.ArrayList;

public class ArabicAdapter extends BaseAdapter {

    Context context;
    public static ArrayList<Bitmap> imgArray;

    public ArabicAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        ArabicAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, ArabicDetail.class);
