...
import com.ghani.mehndidesign.offline2023.simple.FingerDetail;
...
public class FingerAdapter extends BaseAdapter {
    ...
    public FingerAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        FingerAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    int pos = position;
                    Intent intent = new Intent(context, FingerDetail.class);
