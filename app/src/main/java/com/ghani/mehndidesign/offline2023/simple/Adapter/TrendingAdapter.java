...
public class TrendingAdapter extends BaseAdapter {
   ...
   public static ArrayList<Bitmap> imgArray;
    ...
    public TrendingAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        TrendingAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, TrendingDetail.class);
