...
public class BridalAdapter extends BaseAdapter {

    Context context;
    public static ArrayList<Bitmap> imgArray;

    public BridalAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        BridalAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, BridalDetail.class);
