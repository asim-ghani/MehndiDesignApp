...
import com.ghani.mehndidesign.offline2023.simple.EidDetail;
...
public class EidAdapter extends BaseAdapter {
    ...
    public EidAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        EidAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, EidDetail.class);
