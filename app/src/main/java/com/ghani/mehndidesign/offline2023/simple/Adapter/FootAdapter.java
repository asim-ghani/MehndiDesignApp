...
import com.ghani.mehndidesign.offline2023.simple.FootDetail;
...
public class FootAdapter extends BaseAdapter {
    ...
    public FootAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        FootAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, FootDetail.class);
