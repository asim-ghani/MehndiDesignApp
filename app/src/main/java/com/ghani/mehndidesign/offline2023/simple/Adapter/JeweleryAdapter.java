...
import com.ghani.mehndidesign.offline2023.simple.BridalDetail;
import com.ghani.mehndidesign.offline2023.simple.JeweleryDetail;
import com.ghani.mehndidesign.offline2023.simple.R;

import java.util.ArrayList;

public class JeweleryAdapter extends BaseAdapter {

    Context context;
    public static ArrayList<Bitmap> imgArray;

    public JeweleryAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        JeweleryAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, JeweleryDetail.class);
