...
import com.ghani.mehndidesign.offline2023.simple.BhandDetail;
import com.ghani.mehndidesign.offline2023.simple.BridalDetail;
import com.ghani.mehndidesign.offline2023.simple.R;

import java.util.ArrayList;

public class BhandAdapter extends BaseAdapter {

    Context context;
    public static ArrayList<Bitmap> imgArray;

    public BhandAdapter(Context context, ArrayList<Bitmap> imgArray) {
        this.context = context;
        BhandAdapter.imgArray = imgArray;
    }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(context, BhandDetail.class);
